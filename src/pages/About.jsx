            ...
            <FadeIn delay={0.1}>
              <div className="text-center">
                ...
                <p className="text-white/80 max-w-2xl mx-auto leading-relaxed">
                  The one-man army behind Bonehead Labs. Currently wearing every hat imaginable—from coding and art to business development and community management. 
                  When not building games, you'll find me experimenting with new technologies, sharing knowledge with fellow developers, or planning the next big thing.
                </p>
              </div>
            </FadeIn>
          </div>
